...
// import {Card, CardHeader, CardBody,Button,CardFooter, Form, FormGroup, Input, Label, Modal, ModalBody, ModalFooter, ModalHeader} from 'reactstrap'
...
export function Profile() {    
    ...
    return (
      <div className='profile-bg'>
                ...
                <div className='row'>
                    ...
                    <div className='col'>
                            ...
                            <div className='row'>
                                <div className='col-5'>
                                    { qrcodeurl === null ? (
                                        <img src="/qrcode.png" className="qrCode1" alt=""/>
                                    )
                                    :
        ...
        {/* <Modal isOpen={this.state.showmfa} backdrop={false}  centered size="lg" toggle={this.showmfaModal}>  
                      <ModalHeader className="bg-primary text-white" toggle={this.closemfaModal}>
                        2-FACTOR AUTHENTICATION
                      </ModalHeader>
                      <ModalBody className='text-center'>
...

                        {
                            ...
                            <div><img className='qrcode' src={this.state.qrcodeurl} alt=""/></div>
                            ) :
                            <></>
                        }
                            ...
                            <Button  onClick={this.enableMFA} color="success text-white mt-3">Enable</Button>      
                            <Button onClick={this.disableMFA}  color="secondary text-white mt-3 btn-space">Disable</Button>      

                      </ModalBody>
                      <ModalFooter>
                        <div className='w-100 text-left text-danger lnk6'>{this.state.mfaMsg}</div>
                      </ModalFooter>
                    </Modal> */}
    </div>
    );
